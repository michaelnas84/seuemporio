...
<div class="modal fade" id="modal-carrinho" role="dialog">
  ...
  <div class="modal-body">
   ...
   <?php if(@$_SESSION['cpf_usuario'] == ''){
    echo 'Você precisa estar logado, faça seu login clicando <a class="vermelho-link" href="login" target="_blank" title="Ir para o Login"> aqui </a>, caso não tenha login faça seu cadastro!';
